...
contract("Prediction Market", addresses => {
    ...
    it("Should Work Properly", async ()=> {
        ...
        await predictionMarket.placeBet(side.SandP500, {from: gambler1, value: web3.utils.toWei('1')});
        await predictionMarket.placeBet(side.SandP500, {from: gambler2, value: web3.utils.toWei('1')});
        await predictionMarket.placeBet(side.SandP500, {from: gambler3, value: web3.utils.toWei('2')});
        await predictionMarket.placeBet(side.DEFI, {from: gambler4, value: web3.utils.toWei('4')});

        await predictionMarket.reportResult(side.SandP500, side.DEFI, {from: oracle});
